...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "why", "when", "which", "is", "are", "am"]
...
def SpeechRecognition():
    # File ko refresh karke fetch karenge
    driver.get(Link)
    
    # 1. SMART WAIT LAYER: Element load hone ke liye chota sa hard pause denge
    time.sleep(1.5) 
    ...
    try:
        ...
        print("\n[Error: HTML 'start' button load hone se pehle hi check ho gaya. Re-trying...]")
        return None
...
if __name__ == "__main__":
    while True:
        ...
        if Text:  # Sirf tabhi print hoga jab valid text milega
            print(Text)